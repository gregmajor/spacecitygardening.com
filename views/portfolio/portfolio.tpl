            ...
            <div class="row">
               <div class="col-lg-12">
                  <div class="page-title-wrapper">
                     ...
                     <h1 class="page-title mb-10">case study</h1>
      ...
      <div class="portfolio-area pt-120 pb-90">
         <div class="container">
            <div class="portfolio-tab-wrapper wow fadeInUp" data-wow-delay=".3s">
               <div class="portfolio-tab-nav mb-50">
                  <nav>
                     <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        ...
                        <button class="nav-link" id="nav-6-tab" data-bs-toggle="tab" data-bs-target="#nav-6"
            ...
            <div class="portfolio-btn mt-40 mb-30 text-center wow fadeInUp" data-wow-delay=".3s">
               <a href="#" class="fill-btn">Load More<i class="fal fa-plus"></i></a>
            </div>
         </div>
      </div>
      <!-- portfolio area end  -->