...
import (
	...
	_ "spacecitygardening.com/app"
	controllers1 "spacecitygardening.com/app/controllers"
	tests "spacecitygardening.com/tests"
...
func Register() {
	...
	revel.RegisterController((*controllers1.About)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "Index",
				Args: []*revel.MethodArg{ 
	...
	revel.RegisterController((*controllers1.Blog)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "Index",
				Args: []*revel.MethodArg{ 
			...
			&revel.MethodType{
				Name: "Get",
				Args: []*revel.MethodArg{ 
					&revel.MethodArg{Name: "slug", Type: reflect.TypeOf((*string)(nil)) },
				},
				RenderArgNames: map[int][]string{ 
					20: []string{ 
						"slogan",
	...
	revel.RegisterController((*controllers1.BlogEntry)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "Get",
				Args: []*revel.MethodArg{ 
	...
	revel.RegisterController((*controllers1.Common)(nil),
		[]*revel.MethodType{
